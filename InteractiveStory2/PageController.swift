...
class PageController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let page = page {
            ...
            // create a "string w/ attributes" object out of storyLabel text....
            ...
            // add button actions with #selector(method) rather than IBOutlets.....
            if let firstChoice = page.firstChoice {
                ...
                firstChoiceButton.addTarget(self, action: #selector(PageController.playAgain
