...
// adding String protocol conformance would provide rawValue of type String....
//...but having rawValues from "Story: String" doesn't allow for "Associated Values..."
enum Story {
    ...
    // computed "rawValue" properties ...allow for "Associated Values"...
    var rawValue: String {
        switch self {
...
// "Adventure" is referred to as a "Wrapper"...bringing the various objects together in one struct...
struct Adventure {
    static func trip(name: String) -> Page {
